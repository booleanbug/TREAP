...
void getSize(char *filename1,int* sizePointer){ // we are getting the graph  input in form of file
    int x;
    FILE* fp;
    int i,j;
...
int fillArray(char *filename1,studentNode* arrayHeadPointer){ // we are getting the graph  input in form of file
    int groupSize;
